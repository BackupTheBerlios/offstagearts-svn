...
void all_doSelect(SqlRunner str)
{
    ...
    private void initComponents() {
        ...
        ddType = new citibob.swing.typed.JKeyedComboBox();
        ...
        ddType.setMinimumSize(new java.awt.Dimension(110, 23));
        ddType.setPreferredSize(new java.awt.Dimension(110, 23));
        duedatesButtons.add(ddType);
...
// TODO add your handling code here:
	...
	{//GEN-HEADEREND:event_ddAddActionPerformed
		...
		public void run() throws Exception {
			...
			duedatesDm.getSchemaBuf().insertRow(-1,
				new String[] {"termid", "duedateid", "description"},
				new Object[] {(Integer)smod.getTermID(), val,
					ddType.getKeyedModel().get(val).obj});
		}});
// TODO add your handling code here:
    ...
    private citibob.swing.typed.JKeyedComboBox ddType;
